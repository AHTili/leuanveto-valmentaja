...
function createStreetlifting16WMesocycle(startDateISO, cal = {}) {
  ...
  const weekPlans = [
    ...
    { week:9, days:[
      ...
      laDay("LA — MU +7.5 kg + box squat", 7.5, 4, "+7.5 kg — intensifikaatio alkaa", 2, FS.w9),
    ]},
    { week:10, days:[
