...
| `learnedAcrossSetFatigue` | 0,5 eff-toistoa/sarja | [0,25; 0,75]; preskriptio + estimointi + re-ankkurointi opittava YHDESSÄ | kyllä (yhteisopittavuus-ehto) | [[progressio-across-set-vasymysmalli]] |
