...
export const FALLBACK_MOVEMENT_BANK = [
  ...
  // v4.49.0 (2D-γ): WSBB ME-Upper + GZCL T2 + Sheiko accessory -liikkeet
  { id: "fb_floor_press",           name: "Floor press",                    category: "horisontaalityöntö", loadType: "external" },
  { id: "fb_pin_press",             name: "Pin press",                      category: "horisontaalityöntö", loadType: "external" },
