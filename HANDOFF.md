...
>
> *Tämänhetkinen tila: tyhjä pohja. Seuraava handoff: paluuramppi (breakAnalysis liiketasolle + K2-ohjelmointikytkentä) — Cowork laatii. Avoimet syötteet: docs/OBS-038-backoff-preview-confirm.md (K1-pikakorjaus + DESIGN-D1), docs/backlog.md (D-sarjaloki).*
...
`<A1, A2, … — koneellisesti tarkistettavina (P-013 M2); known-positive + known-negative; UI-poluille oppi 8 (e2e render-tasolla)>`
