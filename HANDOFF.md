...
| Seuraava askel | **STOP push-portille — Akseli ratifioi.** Push-lupa OSA 2 -committeille (dd6c949..b4f5c07) + **A8-puhelinverifiointi** (4.52.41: avaa app → Liikepankista löytyy "Käsipainopenkki", + workout-flow "+ Liike" tarjoaa sen). Sitten H-018 kokonaan valmis → arkistointi. EI pushia ilman lupaa. |
