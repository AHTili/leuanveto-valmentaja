...
| Seuraava askel | **STOP OSA 1/OSA 2 -portille — Akseli ratifioi.** Push-lupa OSA 1 -committeille (c22db8d..d7584fa + tämä, origin = 3bad610) JA OSA 2 -aloitus (OBS-041 persistenssi + katalogi — relay nosti prioriteettia: session-katoamisriski). EI pushia/OSA 2:ta ilman lupaa. |
